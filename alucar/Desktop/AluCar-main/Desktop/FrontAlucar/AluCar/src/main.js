...
let currentSlide = 0;
  ...
  document.querySelectorAll('.faq-trigger').forEach(trigger => {
    trigger.addEventListener('click', () => {
      const parent = trigger.parentElement;base
...
const API_URL = 'https://alucar-2mj3.onrender.com'; // Cole a URL gerada pela Render aqui
...
const API_URL = 'https://alucar-backend.onrender.com';
